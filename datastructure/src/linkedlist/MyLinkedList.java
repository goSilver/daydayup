...
public class MyLinkedList {
     ...
     */
    private void reservePrt(Node node) {
        if (node != null) {
     ...
     */
    private boolean isCross(Node head1, Node head2) {
        Node temp1 = head1;
        Node temp2 = head2;
     ...
     */
    Node findFirstCrossPoint(MyLinkedList linkedList1, MyLinkedList linkedList2) {
        //链表不相交
